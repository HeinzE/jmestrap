...
#![allow(dead_code)] // Mock types and CombinedIngress are test-only infrastructure
...
// =============================================================================
// Multi-source ingress combiner (transport composition pattern)
// =============================================================================

/// Combines multiple EventIngress sources into one stream.
/// Runtime alternative to calling spawn_ingress_processor per transport.
